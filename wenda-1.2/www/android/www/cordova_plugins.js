...
module.exports = [
    ...
    //---
     {
        "file": "plugins/org.apache.cordova.camera/www/FunctionFile.js",
        "id": "org.apache.cordova.upload.test",
        "clobbers": [
            "navigator.upload"
        ]
    },
    ...
    {//add by hf for open gps settings view
        "file": "plugins/org.apache.cordova.geolocation/www/CyouGPSSettings.js",
        "id": "org.apache.cordova.geolocation.opengps",
        "clobbers": [
            "gps.setttings"
        ]
    },
...
// TOP OF METADATA
{
    ...
    "org.apache.cordova.webviewapi": "1.0.0",
    "org.apache.cordova.spapi": "1.0.0"
}
// BOTTOM OF METADATA
});