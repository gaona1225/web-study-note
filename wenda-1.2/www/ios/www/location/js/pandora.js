/**
 * @author Wuliang
 * Pandora JavaScript Library v1.2.0
 *
 *
 * Copyright 2011, Next
 ...
 *
 * Copyright 2011, The TCR Foundation
 * Released under the MIT, BSD, and GPL Licenses.
 *
 * Date: Sun Nov 27 16:27:48 2011 -0400
 *
 */
...
(function(window,undefined){
	...
	var Pandora = window.$ = (function() {
		...
		Pandora.extend({
			...
			isTouch : function(){
				return (userAgent.toLowerCase().indexOf('android') >= 0 ||userAgent.toLowerCase().indexOf('iphone') >= 0 ||userAgent.toLowerCase().indexOf('ipad') >= 0 );
			},
