...
(function () {
    ...
    var iframeUrlMap = {
		...
		/*desc by gaona at 2013-02-27 insertqrcode start*/
        'insertqrcode':'~/dialogs/insertqrcode/insertqrcode.html'
		/*desc by gaona at 2013-02-27 insertqrcode end*/
    };
    ...
    var btnCmds = ['undo', 'redo', 'formatmatch',
        ...
        'deletecol', 'splittorows', 'splittocols', 'splittocells', 'mergecells', 'deletetable','insertqrcode'];
    ...
    var dialogBtns = {
        ...
        ok:['attachment', 'anchor', 'link', 'insertimage', 'map', 'gmap', 'insertframe', 'wordimage',
            'insertvideo', 'highlightcode', 'insertframe','edittip','edittable', 'edittd','scrawl', 'template','music', 'background','insertqrcode']
