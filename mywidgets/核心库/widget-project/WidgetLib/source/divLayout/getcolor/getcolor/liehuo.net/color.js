...
***/
(function (){
	var divInnerHtml = '<div style="width:255px;height:255px;margin:12px 0 0 10px;_margin:12px 0 0 5px;float:left"><div style="width:255px;height:255px;background:#ff0000;"><div style="width:255px;height:255px;background:url(getcolor/getcolor/liehuo.net/masks.png);_filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(enabled=true, sizingMethod=crop, src=getcolor/getcolor/liehuo.net/masks.png);_background:none;" onmousedown="Jcolor().palette(this)"><div style="width:12px;height:12px;background:url(getcolor/getcolor/liehuo.net/choose.png);position:absolute;top:5px;left:4px;_font-size:0;_filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(enabled=true, sizingMethod=crop, src=getcolor/getcolor/liehuo.net/choose.png);_background:none;"></div></div></div></div><div style="width:20px;height:255px;background:url(getcolor/getcolor/liehuo.net/rolling.png);float:left;margin:12px 0 0 12px;" onmousedown="Jcolor().rolling(this)"><div style="width:32px;height:9px;background:url(getcolor/getcolor/liehuo.net/rolling_B.png);position:absolute;top:9px;left:272px;_font-size:0;_filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(enabled=true, sizingMethod=crop, src=getcolor/getcolor/liehuo.net/rolling_B.png);_background:none;"></div></div>';
	var colorDiv = '<div style="width:410px;height:284px;background:url(getcolor/getcolor/liehuo.net/bg.png);">'+divInnerHtml+'<div style="width:60px;height:auto;float:left;margin:10px 0 0 10px;font-size:12px;"><div style="width:auto;height:195px;"><table width="100%" height="100 border="0" cellpadding="0" cellspacing="5"><tr><td align="center" valign="middle">R:</td><td align="center" valign="middle"><input style="width:40px;height:14px;" type="text" value="255"/></td></tr><tr><td align="center" valign="middle">G:</td><td align="center" valign="middle"><input  style="width:40px;height:14px;" type="text" value="255"/></td></tr><tr><td align="center" valign="middle">B:</td><td align="center" valign="middle"><input style="width:40px;height:14px;" type="text" value="255"/></td></tr><tr><td></td><td style="border:solid 1px #000;background:#fff;height:40px;"></td></tr><tr><td></td><td><input type="text" style="width:40px;" value="#ffffff"/></td></tr></table></div><div style="width:81px;height:59px;background:url(getcolor/getcolor/liehuo.net/button.png);margin-left:3px;cursor:pointer;" onclick="Jcolor().Ru();"></div></div></div>';
	var ID = 'Jcolor';
	var R = 255;
	var G = 255;
	var B = 255;
