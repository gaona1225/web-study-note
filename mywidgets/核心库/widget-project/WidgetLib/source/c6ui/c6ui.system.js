 ...
 */ 
 (function($){
	...
	eddyCommon = options.hand,
		...
		var infoBox =$("<div class='c6ui-userInfo' style='top:"+ _y +"px;left:" + _x +"px;'><div class='photoBox'><img src='"+ options.photo +"' style='width:80px;height:80px;' /><img class='status' src='"+ options.status +"' title='"+ options.statusTxt +"' /></div><div class='InfoTxt'><h6 class='name'>"+ options.name +"</h6>"+ options.org +"<br/>"+ options.duty +"<br/>手机:"+ options.mobi +"<br/>电话:"+ options.phone +"</div><div class='bottom'><input data-img='../JHsoft.UI.Lib/images/icon.system/16px/balloon-ellipsis.png' type='button' class='c6ui-button' value='寻呼' id ='eddy'/></div><div class='tria "+ eddyCommon +"'></div></div>");
		$("body").append(infoBox);
