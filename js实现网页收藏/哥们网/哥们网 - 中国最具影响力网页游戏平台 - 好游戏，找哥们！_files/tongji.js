...
{
	var unit_id     = "1756236";
	var client_ip   = "119.188.50.2";
	var server_time = "1397643336";
	var verify_code = "7096b0da";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/1756236/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
